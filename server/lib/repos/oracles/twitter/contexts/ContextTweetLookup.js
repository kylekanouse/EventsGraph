 ...
 * @class
 */
class ContextTweetLookup extends Context_1.Context {
    constructor() {
        /**
         * _id
         *
         ...
         */
        super(...arguments);
        this._id = constants_1.constants.TWITTER_TWEET_LOOKUP_CONTEXT_ID;
    }
    /**
    ...
    async getData(request) {
        ...
        if (!((_a = request.params) === null || _a === void 0 ? void 0 : _a.id)) {
            throw new Error(constants_1.constants.TWITTER_TWEET_NO_ID_PROVIDED);
        }
        // Use Twitter Service to get tweet by ID
        return TweetService_1.TweetService.getTweet((_b = request.params) === null || _b === void 0 ? void 0 : _b.id, this._buildRequestParameters(request), request);
    }
    /**
     * getDataStream
     *
...
// Export
exports.default = new ContextTweetLookup();
//# sourceMappingURL=ContextTweetLookup.js.map