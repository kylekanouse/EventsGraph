...
class ContextViolationNetwork extends Context {

  protected _id: string = constants.SYLVA_VIOLATION_NETWORK_CONTEXT_ID
  ...
  public async getData(
    ...
    const graphData = await this._analytics.computeViolationNetwork()
  ...
  public getDataStream(
    ...
    cb(new Error('ContextViolationNetwork does not support streaming'))
  }
}

export default ContextViolationNetwork
