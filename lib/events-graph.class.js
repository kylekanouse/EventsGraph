...
class EventsGraph {
  ...
  addEGLink( egLink ) {
    if (!(egLink instanceof EventsGraphLink)) { return this; }
  ...
  addEGNode(egNode) {
    if (!(egNode instanceof EventsGraphNode)) { return this; }

    // Add Node graph data to grpah nodes
  ...
  removeEGLink(egLink) {
    if (!(egLink instanceof EventsGarphLink)) { return this; }
  ...
  this._graph
    ...
    .nodeThreeObject((node) => {
      ...
      // Check if data provides image for an icon
      if (node.icon) {
